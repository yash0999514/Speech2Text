...
# -----------------------------
ASSEMBLYAI_API_KEY = os.getenv("4186eb45698741cd8d5c39cfb9f6913c")
if not ASSEMBLYAI_API_KEY:
    st.error("❌ AssemblyAI API Key not found! Please set ASSEMBLYAI_API_KEY in environment variables.")
    st.stop()
...
st.markdown("---")
st.caption("Upload: Whisper (faster-whisper) • Live mic: AssemblyAI • Built with Streamlit + WebRTC")
